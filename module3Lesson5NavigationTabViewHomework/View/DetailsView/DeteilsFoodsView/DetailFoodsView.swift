...
struct DetailFoodsView: View {
    ...
    @State private var selectedSize: PortionSizeFoods = .medium
    @State private var countFood: Int = 1
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .center, spacing: 20) {
                    ...
                    HStack(alignment: .center, spacing: 10) {
                        ForEach(PortionSizeFoods.allCases, id: \.self) { size in
                            Button {
                                selectedSize = size
                            } label: {
                                ZStack {
                    ...
                    HStack(alignment: .center) {
                        HStack(spacing: 14) {
                            ...
                            Text("\(String(format: "%.1f", price * selectedSize.rawValue))р") // Жена сказала что так лучше
                    ...
                    Button {
                        ...
                        HStack(spacing: 14) {
                            ...
                            Text("\(String(format: "%.1f", Double(countFood) * price * selectedSize.rawValue))р")
                                .font(.headline)
                                .foregroundColor(.white)
                                .fontWeight(.bold)
                        }
